...
import { useKPIDefinition, useKPIDefinitions, useUsersKPIs } from "@/wedded/api/hooks";
import { KPIDefinition } from "@/wedded/api/endpoints/types";
import {
  KPIBreadcrumb,
  KPIDetailHeader,
  KPIBusinessContext,
...
export default function KPIDetailPage({ params }: PageProps) {
  ...
  const { data: categoryData, isLoading: isLoadingData } = useUsersKPIs();
