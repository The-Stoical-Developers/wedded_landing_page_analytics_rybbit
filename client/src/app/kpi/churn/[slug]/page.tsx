...
import { useKPIDefinition, useKPIDefinitions, useChurnKPIs } from "@/wedded/api/hooks";
import {
  KPIBreadcrumb,
  KPIDetailHeader,
  KPIBusinessContext,
...
export default function KPIDetailPage({ params }: PageProps) {
  ...
  const { data: categoryData, isLoading: isLoadingData } = useChurnKPIs();
